...
const FormContainer = styled.div`
  border-radius: 8px;
  background-color: ${colors.fouro || '#f2f2f2'};
  padding: 30px;
...
function Anemie() {
    ...
    const handleSubmit = async (e) => {
        ...
        dataToSend.append('tauxHemoglobine', formData.tauxHemoglobine);
        ...
        try {
            ...
            const response = await fetch('http://127.0.0.1:8000/api/predict-blood-smear', {
                method: 'POST',
                body: dataToSend,
            });
    ...
    return (
       <FormContainer>
      <Title>Faire un test d'anemies</Title>
